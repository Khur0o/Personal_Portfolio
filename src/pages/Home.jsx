    ...
    return (
        <section className="Home" id="Home">
            <div className="Home-LeftSide">
                ...
                />
                <div className="set">
                    <a href="/public/Resume_PC.pdf" target="_blank" download className="download-button">Download CV</a>
                    <a href="https://www.linkedin.com/in/pcomon/" target="_blank"><img className="linkedin" src="https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/linkedin.svg" alt="linkedin-icon" /></a>
                    <a href="https://github.com/Khur0o" target="_blank"><img className="github" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" alt="github-icon" /></a>
                </div>
            </div>
